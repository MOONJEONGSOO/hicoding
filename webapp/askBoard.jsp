										...
										<div class="table-wrapper">
														<table>
															...
															<tbody>
																<tr>
																	<td>5</td>
																	<td class="tit"><a href="news.jsp">문의4</a></td>
																	<td>관리자</td>
																	<td>2022-02-21</td>
																	<td>526</td>
																</tr>
																<tr>
																	<td>4</td>
																	<td class="tit"><a href="news.jsp">문의3</a></td>
																	<td>작성자</td>
																	<td>2022-02-21</td>
																	<td>222</td>
																</tr>
																<tr>
																	<td>3</td>
																	<td class="tit"><a href="news.jsp">문의2</a></td>
																	<td>작성자</td>
																	<td>2022-02-21</td>
																	<td>333</td>
																</tr>
																<tr>
																	<td>2</td>
																	<td class="tit"><a href="news.jsp">문의1</a></td>
																	<td>작성자</td>
																	<td>2022-02-21</td>
																	<td>222</td>
																</tr>
																<tr>
																	<td>1</td>
																	<td class="tit"><a href="news.jsp">문의사항</a></td>
																	<td>작성자</td>
																	<td>2022-02-21</td>
																	<td>526</td>
																</tr>
